...
public abstract class ACommonPage extends ATopPage {
	...
	private class UserAccount {
		...
		public UserAccount(WebDriver driver) {
			this.driver = driver;
			this.changePassword = this.driver.findElement(By.cssSelector("a.change-password"));
			this.resetPassword = this.driver.findElement(By.cssSelector("a.reset-my-password"));
			this.logout = this.driver.findElement(By.xpath("//a[contains(@href,'/logout')]"));
		}
