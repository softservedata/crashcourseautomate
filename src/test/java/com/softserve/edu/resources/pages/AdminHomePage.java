...
public class AdminHomePage extends ACommonPage {
	...
	private class CoownersOptions {
		...
		public CoownersOptions(WebDriver driver) {
			this.driver = driver;
			this.active = this.driver.findElement(By.xpath("//ul/li[1]/a[contains(@href,'/users/get-all-users')]"));
			this.inactive = this.driver.findElement(By.xpath("//a[contains(@href,'/users/get-all-users?statusType=inactive')]"));
			this.nonConfirmed = this.driver.findElement(By.xpath("//a[contains(@href,'/users/get-all-users?statusType=notcomfirmed')]"));
			this.blocked = this.driver.findElement(By.xpath("//a[contains(@href,'/users/get-all-users?statusType=block')]"));
		}
